...
export function KpiCard({ label, value, change, trend, delay = 0, urgency }: KpiCardProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "bg-white dark:bg-zinc-900 rounded-2xl border p-5 flex flex-col gap-3 overflow-hidden relative",
      ...
      >
        ...
        <div className="flex items-end justify-between gap-2">
          ...
          {change !== undefined && (
            <div
              className={cn(
                "flex items-center text-xs font-semibold px-2 py-0.5 rounded-full mb-0.5",
